    ...
    return (
        <section id="testimonial">
            <div className="max-w-7xl mx-auto px-4 mt-20">
                ...
                <motion.div className="grid grid-cols-1 gap-8 justify-items-center"
                initial="hidden"
                whileInView="visible"
                variants={{
                    visible:{
                ...
                >
                    {TESTIMONIALS_CONTENT.reviews.map((review, index) => (
                        ...
                        className="mt-10 flex flex-col items-center justify-center overflow-hidden rounded-2xl bg-neutral-900/50 border border-neutral-900 p-10 max-w-2xl w-full">
                            <p className="mb-4 text-neutral-200 text-center text-base">{review.review}</p>
