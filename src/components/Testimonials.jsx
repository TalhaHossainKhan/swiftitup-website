    ...
    <section id="testimonial">
        <div className="max-w-7xl mx-auto px-4 mt-20">
            ...
            transition={{duration: 0.6, ease: "easeOut"}}>
                <h2 className="text-3xl lg:text-5xl mt-20text-3xl lg:text-5xl mt-20 tracking-tighter bg-gradient-to-t from-neutral-50 via-neutral-300 to-neutral-600
            ...
            >
                {TESTIMONIALS_CONTENT.reviews.map((review, index) => (
                    ...
                    className="mt-10 flex flex-col items-center justify-center overflow-hidden rounded-2xl bg-neutral-900/50
                    border border-neutral-900 p-10">
